...
- (void)applicationDidFinishLaunching:(CPNotification)aNotification
{
    ...
    var newHeight = ([[_stepsWindowController tableView] rowHeight] * 10) + 54;
...
- (IBAction) openLinkInNewTab:(id)sender
{
    ...
    switch([sender tag]){
        case GITHUB_REPO:
            url = "https://github.com/ArgosOz/Cappuccino-Cookbook-Recipes/tree/master/CPResponder-Basics";
            break;
        case CLASS_REFERENCE:
            url = "http://www.cappuccino-project.org/learn/documentation/interface_c_p_responder.html";
            break;
        case APPLE_REFERENCE:
            url = "https://developer.apple.com/documentation/appkit/nsresponder?language=objc";
            break;
        case DASH:
            url = "dash://cappuccino:CPResponder";
            openNewTab = "_self";
            break;
        case TEST_APP1:
